  ...
  #  cols_X = cat_fits_X[1].columns.names
    ...
    if HI:
        ...
        if mass_function:   
          ...
          #  plt.hist(, histtype='step', fill=False,bins = 100, log=True,label = 'predicted HI from spirals', alpha = 1, normed=norm)
    ...
    plt.legend()
    plt.savefig('cross/plots/MHI_pred_vs_MHI%s.png'%cat2.split('_')[-1].split('.fits')[0])
    ...
    plt.legend()
    plt.savefig('cross/plots/MHI_pred_vs_MHI_res%s.png'%cat2.split('_')[-1].split('.fits')[0])
...
if __name__=='__main__':
    cat_name_pattern = '/home/a.bonaldi/data-cold-for-backup/SDC2/TRECS_outputs/sdc2_smallcube1/continuum/catalogue_continuum_z*.fits'

    #cat_name_pattern =  '/Users/p.hartley/Dropbox (SKA)/sdc2_fullcube/continuum/catalogue_continuum_z*.fits'
